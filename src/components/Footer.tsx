    ...
    <footer className="px-8 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="col-span-2 md:col-span-1">
          <Image src={logo_2} alt="Logo footer" priority />
        </div>

        {FooterLink.map((item, index) => (
          <div key={index} className="col-span-2 md:col-span-1">
            <Typography variant="span" className="text-secondary-500">
              {item.name}
            </Typography>
        ...
        <div className="flex items-start gap-4">
          <Link
            href="#"
            className="bg-secondary-500 text-primary flex items-center justify-center rounded-full p-4 h-16 w-16"
          >
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-secondary-500 lg:flex-row">
