  ...
  return(
    <section ref={ref} className="container overflow-x-hidden">
      ...
      className="col-span-12 md:col-span-6 md:py-8 pt-[20vh] md:h-[100vh] h-screen flex flex-col justify-center items-center md:items-start">
        ...
        <Typography variant="p" className="text-secondary-100 dark:text-grey-100 md:text-start text-center">
        ...
        <div className="flex items-center gap-4 mt-4 md:flex-row flex-col">
          <CTA url="/Service" className="flex items-center justify-center bg-primary text-secondary-500 py-4 md:py-2 h-full w-full md:w-fit min-w-[224px] max-w-[384px] mt-4">
            <Typography variant="small" className="uppercase text-[12px] font-bold">Comment nous travaillon</Typography>
          </CTA>
          <CTA url="/Contact" className="flex items-center justify-center space-x-2 md:space-x-4 border dark:border-grey-100 border-secondary-500 text-secondary-500 dark:text-grey-100 h-full w-full md:w-fit min-w-[224px] max-w-[384px] mt-4">
    ...
    <section ref={ref} className="container overflow-x-hidden">
      <div className=" flex justify-center gap-8 md:justify-between flex-wrap mt-16 md:mt-0">
        ...
        >
          ...
          <Typography variant="p" className="text-secondary-100 dark:text-grey-100 md:text-start text-center">
            L&apos;agence propose une gamme complète de services <br /> comprenant des
            compétences techniques du design et <br /> une compréhension du monde des affaires.
          </Typography>
          <CTA url="/Service" className="bg-primary text-secondary-500 md:mx-0 mx-auto w-fit max-w-[384px] min-w-[224px] mt-4">
            <Typography variant="small" className="uppercase text-[12px] font-bold">
              Découvrir tout
            </Typography>
          </CTA>
        </motion.div>
        ...
        >
          <Image src={home_2} alt="Produit" quality={95} className="w-[480px]" />
        </motion.div>
      </div>
    </section>
  );
    ...
    toast.success("Email send successfully!")
     ...
     className="grid grid-cols-2 gap-4 grid-flow-dense">
      <div className="flex col-span-2 md:col-span-1 flex-col gap-2">
        <label htmlFor="name" className="text-sm uppercase text-secondary-500 dark:text-grey-100 font-semibold">
      ...
      <div className="flex flex-col gap-2 col-span-2 md:col-span-1">
        <label htmlFor="email" className="text-sm uppercase text-secondary-500 dark:text-grey-100 font-semibold">
          Mail
        </label>
        <input
          type="email"
      ...
      <div className="flex flex-col gap-2 col-span-2 md:col-span-1">
        <label htmlFor="phone" className="text-sm uppercase text-secondary-500 dark:text-grey-100 font-semibold">
          Numéros téléphone
        </label>
        <input
          type="tel"
      ...
      <div className="flex flex-col gap-2 col-span-2 md:col-span-1">
        <label htmlFor="subject" className="text-sm uppercase text-secondary-500 dark:text-grey-100 font-semibold">
          Objet
        </label>
        <select
          id="subject"
      ...
      <div className="flex flex-col gap-2 col-span-2">
        <label htmlFor="message" className="text-sm uppercase text-secondary-500 dark:text-grey-100 font-semibold">
          Message
        </label>
        <textarea
          id="message"
...
function SubmitButton(){
  ...
  return(
    <button type="submit" disabled={pending} className="p-2 disabled:scale-100 disabled:bg-opacity-65 rounded-lg bg-primary text-secondary-500 w-full md:w-fit min-w-[224px] max-w-[384px] mt-4 uppercase flex items-center justify-center space-x-4">
      {
        pending ? <div className="h-5 w-5 animate-spin rounded-full border-b-2 border-secondary-500"></div> : (
          <>
